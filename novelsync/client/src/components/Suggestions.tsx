...
const Suggestions = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-4 sm:p-6 bg-amber-50 rounded-lg shadow-lg border border-amber-200">
      ...
      {suggestions.length > 0 && (
        <div
          ref={suggestionsRef}
          className="mt-4 sm:mt-6 bg-white border-2 border-amber-200 rounded-lg p-3 sm:p-4 max-h-60 overflow-y-auto scrollbar-thin scrollbar-thumb-amber-400 scrollbar-track-amber-100"
        >
